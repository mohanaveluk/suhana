...
export const FALLBACK_TIPS: SafetyTip[] = [
  ...
  { id: '42c79afb-0043-4e54-ad80-52a762c3999f', title: 'Never Share Your OTP Code', category: SafetyCategory.ACCOUNT_SECURITY, content: 'Aurora will never ask for your OTP over phone or chat. If someone claiming to be from Aurora asks for your OTP, it is a scam — report it immediately.', displayOrder: 3, isFeatured: false },
  { id: '3336ec09-3621-4063-b0f1-8077b2d1718d', title: 'Log Out from Shared Devices', category: SafetyCategory.ACCOUNT_SECURITY, content: 'Always log out from your Aurora account when using shared computers, phones, or public devices to prevent unauthorized access to your profile.', displayOrder: 4, isFeatured: false },
  ...
  { id: 'df45258b-ca5f-498a-b66c-a059638b9574', title: 'Use a Secure Internet Connection', category: SafetyCategory.ONLINE_SAFETY, content: 'Avoid accessing your Aurora account over public Wi-Fi. Use mobile data or a trusted home connection, or use a reputable VPN when on public networks.', displayOrder: 2, isFeatured: false },
  { id: '981a4aa3-5314-4403-9b70-bedca13cf65c', title: 'Keep Your App and Device Updated', category: SafetyCategory.ONLINE_SAFETY, content: 'Keep your browser, Aurora app, and device operating system updated to ensure you have the latest security patches against known vulnerabilities.', displayOrder: 3, isFeatured: false },
  ...
  // Communication
  { id: '665b16b4-e08e-4726-8553-474c3fc349a9', title: 'Keep Conversations on the Platform', category: SafetyCategory.COMMUNICATION, content: 'Use Aurora\'s built-in messaging system initially. Moving too quickly to personal numbers or third-party apps removes platform protections and can expose you to fraud.', displayOrder: 1, isFeatured: false },
