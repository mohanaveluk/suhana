...
export class PdfReportService {
  ...
  generateCompatibilityReport(input: GenerateReportInput): CompatibilityReportData {
    ...
    return {
      ...
      generatedAt,
      fileName: `Aurora_Match_Report_${brideCode}_${groomCode}.pdf`,
  ...
  private drawHeader(doc: jsPDF, cur: Cursor, data: CompatibilityReportData): void {
    ...
    doc.text('Aurora Matrimony', this.M, 15);
  ...
  private drawFooters(doc: jsPDF, data: CompatibilityReportData): void {
    ...
    for (let i = 1; i <= total; i++) {
      ...
      doc.text('Generated by Aurora Matrimony AI Matchmaking Engine', this.M, this.PAGE_H - 9);
      doc.text('www.auroramatrimony.com', this.M, this.PAGE_H - 5);
